        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="absolute group transition-transform hover:scale-110 active:scale-95 outline-none z-30 flex items-center justify-center rounded-full bg-neutral-100 hover:bg-accent hover:text-white transition-colors duration-300"
                    style={{ left: '609px', top: `${2454 - Y_OFFSET + 50}px`, width: '90px', height: '90px' }}
                >
                    <ChevronLeft className="w-8 h-8 text-foreground group-hover:text-white transition-colors duration-300" strokeWidth={1.5} />
                </button>
                ...
                >
                    <ChevronRight className="w-8 h-8 text-foreground group-hover:text-white transition-colors duration-300" strokeWidth={1.5} />
                </button>
            </div>
        </section>
    );
